...
export class EmpleadoComponent {
  ...
  asignarme()
  {
    ...
    return this.propietarioService.asignarmePedido(this.codigoP.numeroP, logeado).subscribe((data) => {
      console.log(data);
    })
  }
  ...
  pedidoListo()
  {
    ...
    return this.propietarioService.enviarMensaje('cliente@gmail.com', this.codigoP.numeroP).subscribe((data) =>{
